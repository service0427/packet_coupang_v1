...
사용 예시:
  # 쿠키 생성
  python3 coupang.py cookie -t 2 -l 10
...
"""
    ...
    cookie_parser.add_argument('-t', '--threads', type=int, default=2, help='쓰레드 수 (기본: 2)')
    cookie_parser.add_argument('-l', '--loop', type=int, default=10, help='조합당 쿠키 수 (기본: 10)')
    ...
    rank_parser.add_argument('--click', action='store_true', help='클릭 테스트')
